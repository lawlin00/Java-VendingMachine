...
public class Login extends DefaultFrame {
    ...
    public void setImage(){
        ImageIcon iconProfile = new ImageIcon("Image/Login2.png");
      //  jImg.setIcon(iconProfile);
        Image image = iconProfile.getImage();
        image = image.getScaledInstance(225,225,Image.SCALE_SMOOTH);
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("STXinwei", 1, 36)); // NOI18N
        ...
        txtUser.setFont(new java.awt.Font("Sylfaen", 1, 24)); // NOI18N

        txtPsw.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N

        btnLogin.setBackground(new java.awt.Color(204, 255, 204));
        btnLogin.setFont(new java.awt.Font("Sitka Heading", 1, 24)); // NOI18N
        ...
        jButton1.setText("User Interface");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(80, 80, 80)
                .addComponent(jImg, javax.swing.GroupLayout.PREFERRED_SIZE, 232, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    public void verifyLogin(String username, String password)
    {
        ...
        try{
            ...
            while (x.hasNextLine() && !found){
                ...
                tempUsername = split[0];
                tempPassword = split[1];
               // x.nextLine();
